...
const createProduct = z.object({
    body: z.object({
        ...
        salePrice: z.string().min(1, { message: "Sale price is required!" }).optional(),
        flashPrice: z.string().min(1, { message: "Flash price is required!" }).optional(),
        discount: discountSchema,
        stock: toNumber(0).optional(),
        stockAlrt: toNumber(0).optional(),
        isInStock: toBoolean,
